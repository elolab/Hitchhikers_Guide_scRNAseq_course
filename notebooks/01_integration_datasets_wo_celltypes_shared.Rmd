...
# Check intersection of top30 marker genes between clusters across batches
shared.genes <- list()
...
# Table with number of genes shared between pbmc vs pancreas clusters for the top30 upregulated genes per cluster
...
## Automatic cell annotation
SaveH5Seurat(seu, filename = file.path("results", "seu.h5Seurat"))
Convert(file.path("results", "seu.h5Seurat"), dest = "h5ad")
```
